...
as
select Exam.Exam_Id, Exam_Date, Course_Name, Exam_Name, group_concat(Topic_Name)
...
as
select Assignment.Assignment_Id, Assignment_Due_Date, Course_Name, Assignment_Type, Assignment_Name, group_concat(Topic_Name)
